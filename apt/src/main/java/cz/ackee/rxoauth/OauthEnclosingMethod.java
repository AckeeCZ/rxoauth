 ...
 **/
public class OauthEnclosingMethod {
    public static final String TAG = OauthEnclosingMethod.class.getName();
    ...
    public OauthEnclosingMethod(ExecutableElement methodElement) {
    ...
    private void scanElement(ExecutableElement methodElement) {
        ...
        this.shouldWrap = methodElement.getAnnotation(NoOauth.class) == null;
